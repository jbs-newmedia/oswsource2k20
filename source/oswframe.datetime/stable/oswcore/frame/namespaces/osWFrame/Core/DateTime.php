...
class DateTime
{
    ...
    public static function setCurrentTimeByDate(
        int $hour,
        int $minute,
        int $second,
        int $month,
    ...
    public static function createTimeByCurrentTimeOffset(
        int $offset_hour,
        int $offset_minute,
        int $offset_second,
        int $offset_month,
        ...
        return mktime(
            date('H', self::getCurrentTime()) + $offset_hour,
            date('i', self::getCurrentTime()) + $offset_minute,
            date('s', self::getCurrentTime()) + $offset_second,
            date('m', self::getCurrentTime()) + $offset_month,
            date('d', self::getCurrentTime()) + $offset_day,
            date('Y', self::getCurrentTime()) + $offset_year
        );
    }
