 ...
 * @license MIT License
 *
 * @var \osWFrame\Tools\Tool\PackageManager $Tool
...
<?php else: ?>
	...
	<table id="oswtools_packagemanager" class="table table-striped table-bordered">
		<thead>
		<tr>
			<th>Tool</th>
			<th>Release</th>
	...
	<a href="javascript:removeAll()" class="mt-3 btn btn-danger d-block">Remove all packages</a>
