...
<div class="form-group ddm_element_<?php echo $this->getSendElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getSendElementOption($element, 'read_only') === true): ?>
        ...
        <div class="form-control readonly"
             style="height:auto;"><?php echo HTML::outputString($this->getSendElementStorage($element)); ?></div>
    ...
    <?php else: ?>
        ...
        <?php echo $this->getTemplate()->Form()->drawTextareaField($element, $this->getSendElementStorage($element), [
