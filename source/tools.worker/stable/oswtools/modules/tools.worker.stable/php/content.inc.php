 ...
 * @license MIT License
 *
 * @var $Tool \osWFrame\Tools\Tool\Worker
 */

$Tool=new \osWFrame\Tools\Tool\Worker('oswframe2k20', 'tools.worker', 'stable');
...
if (in_array(\osWFrame\Core\Settings::getAction(), ['about'])) {
	...
	if ((\osWFrame\Tools\Helper::getDoAction()=='doit')||(\osWFrame\Core\Settings::catchStringPostValue('worker_action')=='dowork')) {
		$Tool->setWorker(\osWFrame\Core\Settings::catchStringPostValue('worker'));
	}
