...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getEditElementOption($element, 'read_only') === true): ?>
        ...
        <div class="form-control readonly"
             style="height:auto;"><?php echo HTML::outputString($this->getEditElementStorage($element)); ?></div>
    ...
    <?php else: ?>
        ...
        <?php echo $this->getTemplate()->Form()->drawTextareaField($element, $this->getEditElementStorage($element), [
