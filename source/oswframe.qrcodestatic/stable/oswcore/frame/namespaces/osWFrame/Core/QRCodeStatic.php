...
class QRCodeStatic
{
    ...
    public static function outputSVG(string $data, array $option = []): void
    {
        $gzip = true;
        ...
        if (!isset($option['moduleValues'])) {
            $option['moduleValues'] = [
                ...
                // alignment
                2560 => 'url(#g1)',
                10 => $option['project_theme_color_bg'], // timing
                3072 => 'url(#g1)',
                12 => $option['project_theme_color_bg'], // format
                3584 => 'url(#g1)',
                14 => $option['project_theme_color_bg'], // version
                4096 => 'url(#g1)',
                16 => $option['project_theme_color_bg'], // data
                1024 => 'url(#g2)',
                4 => $option['project_theme_color_bg'], // darkmodule
        ...
        $options = new QROptions([
            ...
            'eccLevel' => $option['eccLevel'],
            'addQuietzone' => $option['addQuietzone'],
            'cssClass' => $option['cssClass'],
            'svgOpacity' => $option['svgOpacity'],
            'svgDefs' => $option['svgDefs'],
            'moduleValues' => $option['moduleValues'],
        ]);
