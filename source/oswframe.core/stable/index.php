...
if ((!defined('PHP_VERSION_ID')) || (\PHP_VERSION_ID < 80000)) {
    exit('This version of osWFrame requires PHP 8.0 or higher.<br/>You are currently running PHP ' . \PHP_VERSION . '.');
}

/*
 * Definieren des absoluten Pfads.
 */
define('OSWFRAME_CORE_ABSPATH', realpath(__DIR__) . \DIRECTORY_SEPARATOR);

/**
 * Autoloader für Namespaces einbinden.
 */
require_once OSWFRAME_CORE_ABSPATH . 'oswcore' . \DIRECTORY_SEPARATOR . 'frame' . \DIRECTORY_SEPARATOR . 'namespaces' . \DIRECTORY_SEPARATOR . 'osWFrame' . \DIRECTORY_SEPARATOR . 'Autoload.php';

/**
 * Funktionen einbinden.
 */
require_once OSWFRAME_CORE_ABSPATH . 'oswcore' . \DIRECTORY_SEPARATOR . 'frame' . \DIRECTORY_SEPARATOR . 'namespaces' . \DIRECTORY_SEPARATOR . 'osWFrame' . \DIRECTORY_SEPARATOR . 'Functions.php';
 ...
 */
\osWFrame\Core\ErrorLogger::setPHPErrorReporting();
...
if (\osWFrame\Core\Settings::loadConfigure('modules', 'project') !== true) {
    exit('osWFrame is currently not configured.');
}
 ...
 * Hook für Header bei Projekt.
 */
$file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'modules' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('project_default_module') . \DIRECTORY_SEPARATOR . 'php' . \DIRECTORY_SEPARATOR . 'header.inc.php';
if (file_exists($file)) {
    require_once $file;
}
 ...
 * Hook für Header bei Modulen.
 */
$file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'modules' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('frame_default_module') . \DIRECTORY_SEPARATOR . 'php' . \DIRECTORY_SEPARATOR . 'header.inc.php';
if (file_exists($file)) {
    require_once $file;
}
 ...
 */
if ((\osWFrame\Core\Settings::getBoolVar('frame_engine_loaded') !== true) && (\osWFrame\Core\Settings::getStringVar('project_default_engine') !== null)) {
    $file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'frame' . \DIRECTORY_SEPARATOR . 'engines' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('project_default_engine') . '.inc.php';
    if (file_exists($file)) {
        \osWFrame\Core\Settings::setBoolVar('frame_engine_loaded', true);
        require_once $file;
    }
...
/*
 * Engine ausführen bei Frame so fern noch keine Engine ausgeführt wurde.
 */
 ...
 */
if ((\osWFrame\Core\Settings::getBoolVar('frame_engine_loaded') !== true) && (\osWFrame\Core\Settings::getStringVar('frame_default_engine') !== null)) {
    $file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'frame' . \DIRECTORY_SEPARATOR . 'engines' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('frame_default_engine') . '.inc.php';
    if (file_exists($file)) {
        \osWFrame\Core\Settings::setBoolVar('frame_engine_loaded', true);
        require_once $file;
    }
 ...
 * Hook für Footer bei Projekt.
 */
$file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'modules' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('project_default_module') . \DIRECTORY_SEPARATOR . 'php' . \DIRECTORY_SEPARATOR . 'footer.inc.php';
if (file_exists($file)) {
    require_once $file;
}

/*
 * Hook für Footer bei Modulen.
 */
 ...
 * Hook für Footer bei Modulen.
 */
$file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'modules' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('frame_current_module') . \DIRECTORY_SEPARATOR . 'php' . \DIRECTORY_SEPARATOR . 'footer.inc.php';
if (file_exists($file)) {
    require_once $file;
}
 ...
 */
if ((\osWFrame\Core\Settings::getBoolVar('frame_output_loaded') !== true) && (\osWFrame\Core\Settings::getStringVar('project_default_output') !== null)) {
    $file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'frame' . \DIRECTORY_SEPARATOR . 'outputs' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('project_default_output') . '.inc.php';
    if (file_exists($file)) {
        \osWFrame\Core\Settings::setBoolVar('frame_output_loaded', true);
        require_once $file;
    }
 ...
 */
if ((\osWFrame\Core\Settings::getBoolVar('frame_output_loaded') !== true) && (\osWFrame\Core\Settings::getStringVar('frame_default_output') !== null)) {
    $file = \osWFrame\Core\Settings::getStringVar('settings_abspath') . 'oswcore' . \DIRECTORY_SEPARATOR . 'frame' . \DIRECTORY_SEPARATOR . 'outputs' . \DIRECTORY_SEPARATOR . \osWFrame\Core\Settings::getStringVar('frame_default_output') . '.inc.php';
    if (file_exists($file)) {
        \osWFrame\Core\Settings::setBoolVar('frame_output_loaded', true);
        require_once $file;
    }
