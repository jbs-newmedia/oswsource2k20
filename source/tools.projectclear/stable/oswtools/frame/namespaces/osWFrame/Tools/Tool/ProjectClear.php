...
class ProjectClear extends CoreTool {
	...
	protected function setIgnoreDefaultList():self {
		...
		$this->settings['projectclear_dirs'][]='oswtools'.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'json'.DIRECTORY_SEPARATOR.'configure'.DIRECTORY_SEPARATOR.'middle'.DIRECTORY_SEPARATOR;
		$this->settings['projectclear_dirs'][]='oswtools'.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'json'.DIRECTORY_SEPARATOR.'configure'.DIRECTORY_SEPARATOR.'middlebottom'.DIRECTORY_SEPARATOR;
		$this->settings['projectclear_dirs'][]='oswtools'.DIRECTORY_SEPARATOR.'resources'.DIRECTORY_SEPARATOR.'json'.DIRECTORY_SEPARATOR.'configure'.DIRECTORY_SEPARATOR.'bottom'.DIRECTORY_SEPARATOR;
