...
$Tool=new \osWFrame\Tools\Tool\PackageClear('oswframe2k20', 'tools.packageclear', 'stable');
...
if (in_array(\osWFrame\Core\Settings::getAction(), ['about'])) {
	...
	if (\osWFrame\Tools\Helper::getDoAction()=='doclear') {
		$Tool->clearPackages();
		\osWFrame\Core\SessionMessageStack::addMessage('session', 'success', ['msg'=>'Selected packages has been successfully removed.']);
