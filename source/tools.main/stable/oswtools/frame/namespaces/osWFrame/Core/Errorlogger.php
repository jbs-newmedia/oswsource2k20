...
class ErrorLogger {
	...
	public static function getOutput(string $error_status):bool {
		...
		MessageStack::addMessage(self::getNameAsString(), 'error_'.$error_status, ['time'=>time(), 'line'=>__LINE__, 'function'=>__FUNCTION__, 'error_status'=>$error_status, 'remote_addr'=>getenv('REMOTE_ADDR'), 'redirect_url'=>$_SERVER['REDIRECT_URL'], 'http_referer'=>$_SERVER['HTTP_REFERER'], 'http_user_agent'=>$_SERVER['HTTP_USER_AGENT']]);
