...
} elseif (in_array(\osWFrame\Core\Settings::getAction(), ['protecttools'], true)) {
    if (!in_array(\osWFrame\Tools\Helper::getDoAction(), ['new', 'donew', 'manage', 'domanage'], true)) {
...
} elseif (in_array(\osWFrame\Core\Settings::getAction(), ['framekey'], true)) {
    $osW_Form = new \osWFrame\Core\Form();
