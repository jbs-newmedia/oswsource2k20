...
if (Resource::existsResource($this->getClassName(), $name)!==true) {
	$files=['js'.DIRECTORY_SEPARATOR.'dataTables.responsive.js', 'js'.DIRECTORY_SEPARATOR.'dataTables.responsive.min.js', 'js'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.js', 'js'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.min.js', 'css'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.css', 'css'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.min.css'];
...
if ($options['min']===true) {
	$jsfiles=[$path.'js'.DIRECTORY_SEPARATOR.'dataTables.responsive.min.js', $path.'js'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.min.js'];
	$cssfiles=[$path.'css'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.min.css'];
}
else {
	$jsfiles=[$path.'js'.DIRECTORY_SEPARATOR.'dataTables.responsive.js', $path.'js'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.js'];
	$cssfiles=[$path.'css'.DIRECTORY_SEPARATOR.'responsive.bootstrap4.css'];
}
