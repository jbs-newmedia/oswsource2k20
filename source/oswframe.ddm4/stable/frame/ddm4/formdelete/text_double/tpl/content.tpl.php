...
<div class="form-group ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
	...
	<?php /* read only */ ?>
	<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString($this->getDeleteElementStorage($element)); ?></div>
...
<div class="form-group ddm_element_<?php echo $this->getDeleteElementValue($element.'_double', 'id_double') ?>">

	<?php /* label */ ?>
	<label class="form-label" for="<?php echo $element ?>"><?php echo \osWFrame\Core\HTML::outputString($this->getDeleteElementValue($element, 'title_double')) ?><?php if ($this->getDeleteElementOption($element, 'required')===true): ?><?php echo $this->getGroupMessage('form_title_required_icon') ?><?php endif ?><?php echo $this->getGroupMessage('form_title_closer') ?></label>

	<?php /* read only */ ?>
	<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString($this->getDeleteElementStorage($element)); ?></div>
	<?php echo $this->getTemplate()->Form()->drawHiddenField($element.'_double', $this->getDeleteElementStorage($element)) ?>
	...
	<?php /* notice */ ?>
	<?php if ($this->getDeleteElementOption($element.'_double', 'notice')!=''): ?>
		<div class="text-info"><?php echo \osWFrame\Core\HTML::outputString($this->getDeleteElementOption($element.'_double', 'notice')) ?></div>
	<?php endif ?>

	<?php /* buttons */ ?>
	<?php if ($this->getDeleteElementOption($element.'_double', 'buttons')!=''): ?>
		<div>
			<?php echo implode(' ', $this->getDeleteElementOption($element.'_double', 'buttons')) ?>
		</div>
	<?php endif ?>
