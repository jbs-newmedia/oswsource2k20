...
if (($this->getFilterErrorElementStorage($element)!==true)&&(strval(intval($this->getDoAddElementStorage($element)))!==strval($this->getDoAddElementStorage($element)))) {
...
if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'length_min')!='')) {
	if ($this->getDoAddElementStorage($element)=='') {
		...
		$this->setFilterErrorElementStorage($element, true);
	} elseif (strlen($this->getDoAddElementStorage($element))<$this->getAddElementValidation($element, 'length_min')) {
		$fields['length_min']=$this->getAddElementValidation($element, 'length_min');
...
if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'value_min')!='')) {
	if ($this->getDoAddElementStorage($element)<$this->getAddElementValidation($element, 'value_min')) {
		$fields['value_min']=$this->getAddElementValidation($element, 'value_min');
		$this->getTemplate()->Form()->addErrorMessage($element, osWFrame\Core\StringFunctions::parseTextWithVars($this->getGroupMessage('validation_element_tosmall'), $fields));
		$this->setFilterErrorElementStorage($element, true);
	}
}
...
if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'value_max')!='')) {
	if ($this->getDoAddElementStorage($element)>$this->getAddElementValidation($element, 'value_max')) {
		$fields['value_max']=$this->getAddElementValidation($element, 'value_max');
		$this->getTemplate()->Form()->addErrorMessage($element, osWFrame\Core\StringFunctions::parseTextWithVars($this->getGroupMessage('validation_element_tobig'), $fields));
		$this->setFilterErrorElementStorage($element, true);
	}
}
...
if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'preg')!='')) {
	if (!preg_match($this->getAddElementValidation($element, 'preg'), $this->getDoAddElementStorage($element))) {
		$this->getTemplate()->Form()->addErrorMessage($element, osWFrame\Core\StringFunctions::parseTextWithVars($this->getGroupMessage('validation_element_regerror'), $fields));
		$this->setFilterErrorElementStorage($element, true);
	}
}
