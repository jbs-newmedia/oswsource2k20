...
if (($this->getFilterErrorElementStorage($element)!==true)&&(strlen($file_name)>0)) {
	...
	if ($getimagesize!==false) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'width_min')!='')) {
			if ($getimagesize[0]<$this->getAddElementValidation($element, 'width_min')) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'width_max')!='')) {
			if ($getimagesize[0]>$this->getAddElementValidation($element, 'width_max')) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'height_min')!='')) {
			if ($getimagesize[1]<$this->getAddElementValidation($element, 'height_min')) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getAddElementValidation($element, 'height_max')!='')) {
			if ($getimagesize[1]>$this->getAddElementValidation($element, 'height_max')) {
