...
$this->setDoEditElementStorage($element.'_double', osWFrame\Core\Settings::catchValue($element.'_double', '', 'p'));

if ($this->getDoEditElementStorage($element)!=$this->getDoEditElementStorage($element.'_double')) {
