...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
	...
	<?php if ($this->getAddElementOption($element, 'read_only')===true): ?>
		...
		<div class="form-control readonly">
			<?php if ($this->getAddElementStorage($element)!=''): ?>
				...
				<?php $this->getTemplate()->Form()->drawHiddenField($element, $this->getAddElementStorage($element)) ?><?php else: ?><?php echo \osWFrame\Core\HTML::outputString($this->getAddElementOption($element, 'text_blank')) ?><?php endif ?>
		</div>
	...
	<?php else: ?>
		...
		<?php echo $this->getTemplate()->Form()->drawFileField($element, $this->getAddElementStorage($element), ['input_class'=>'form-control-input', 'input_errorclass'=>'is-invalid']) ?>
