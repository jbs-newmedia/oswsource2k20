	...
	<?php if ($this->getAddElementOption($element, 'read_only')===true): ?>
		...
		<div class="form-control readonly">
			...
			<?php else: ?>
				...
				<?php echo $this->getTemplate()->Form()->drawHiddenField($element, strftime($this->getAddElementOption($element, 'format'), mktime(12, 0, 0, substr($this->getAddElementStorage($element), 4, 2), substr($this->getAddElementStorage($element), 6, 2), substr($this->getAddElementStorage($element), 0, 4)))) ?><?php if ($this->getAddElementOption($element, 'month_asname')===true): ?><?php echo strftime(str_replace('%m.', ' %B ', $this->getAddElementOption($element, 'format')), mktime(12, 0, 0, substr($this->getAddElementStorage($element), 4, 2), substr($this->getAddElementStorage($element), 6, 2), substr($this->getAddElementStorage($element), 0, 4))) ?><?php echo $this->getTemplate()->Form()->drawHiddenField($element, strftime(str_replace('%m.', ' %B ', $this->getAddElementOption($element, 'format')), mktime(12, 0, 0, substr($this->getAddElementStorage($element), 4, 2), substr($this->getAddElementStorage($element), 6, 2), substr($this->getAddElementStorage($element), 0, 4)))) ?><?php else: ?><?php echo strftime($this->getAddElementOption($element, 'format'), mktime(12, 0, 0, substr($this->getAddElementStorage($element), 4, 2), substr($this->getAddElementStorage($element), 6, 2), substr($this->getAddElementStorage($element), 0, 4))) ?><?php echo $this->getTemplate()->Form()->drawHiddenField($element, strftime($this->getAddElementOption($element, 'format'), mktime(12, 0, 0, substr($this->getAddElementStorage($element), 4, 2), substr($this->getAddElementStorage($element), 6, 2), substr($this->getAddElementStorage($element), 0, 4)))) ?>
