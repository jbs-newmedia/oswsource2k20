...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
	...
	<?php if ($this->getAddElementOption($element, 'read_only')===true): ?>
		...
		<?php /* read only */ ?>
		<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString($this->getAddElementOption($element, 'text_hidden')) ?></div>

	<?php else: ?>

		<?php /* input */ ?><?php echo $this->getTemplate()->Form()->drawPasswordField($element, $this->getAddElementStorage($element), ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']); ?>
...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element.'_double', 'id_double') ?>">
	...
	<?php /* label */ ?>
	<label class="form-label" for="<?php echo $element.'_double' ?>"><?php echo \osWFrame\Core\HTML::outputString($this->getAddElementOption($element, 'title_double')) ?><?php if ($this->getAddElementOption($element, 'required')===true): ?><?php echo $this->getGroupMessage('form_title_required_icon') ?><?php endif ?><?php echo $this->getGroupMessage('form_title_closer') ?></label>
	...
	<?php else: ?>
		...
		<?php /* input */ ?><?php echo $this->getTemplate()->Form()->drawPasswordField($element.'_double', $this->getAddElementStorage($element), ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']); ?>
