...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
	...
	<?php if (($this->getDoEditElementStorage($element.$this->getEditElementOption($element, 'temp_suffix'))!='')&&($this->getEditElementOption($element, 'read_only')!==true)): ?>
		<div class="custom-control custom-checkbox">
			<?php echo $this->getTemplate()->Form()->drawCheckBoxField($element.$this->getEditElementOption($element, 'temp_suffix').$this->getEditElementOption($element, 'delete_suffix'), 1, 0, ['input_parameter'=>'title="'.\osWFrame\Core\HTML::outputString($this->getEditElementOption($element, 'text_file_delete')).'"', 'input_class'=>'custom-control-input']) ?>
			<label class="custom-control-label" for="<?php echo $element.$this->getEditElementOption($element, 'temp_suffix').$this->getEditElementOption($element, 'delete_suffix') ?>0"><?php echo \osWFrame\Core\HTML::outputString($this->getEditElementOption($element, 'text_file_delete')) ?></label>
		</div>
		...
		<div class="custom-control custom-checkbox">
			<?php echo $this->getTemplate()->Form()->drawCheckBoxField($element.$this->getEditElementOption($element, 'delete_suffix'), 1, 0, ['input_parameter'=>'title="'.\osWFrame\Core\HTML::outputString($this->getEditElementOption($element, 'text_file_delete')).'"', 'input_class'=>'custom-control-input']) ?>
			<label class="custom-control-label" for="<?php echo $element.$this->getEditElementOption($element, 'delete_suffix') ?>0"><?php echo \osWFrame\Core\HTML::outputString($this->getEditElementOption($element, 'text_file_delete')) ?></label>
		</div>
