...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
	...
	<?php if ($this->getEditElementOption($element, 'read_only')===true): ?>
		...
		<?php /* read only */ ?>
		<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString($this->getEditElementOption($element, 'text_hidden')) ?></div>

	<?php else: ?>

		<?php /* input */ ?><?php echo $this->getTemplate()->Form()->drawPasswordField($element, '', ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']); ?>
...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element.'_double', 'id_double') ?>">
	...
	<?php /* label */ ?>
	<label class="form-label" for="<?php echo $element.'_double' ?>"><?php echo \osWFrame\Core\HTML::outputString($this->getEditElementOption($element, 'title_double')) ?><?php if ($this->getEditElementOption($element, 'required')===true): ?><?php echo $this->getGroupMessage('form_title_required_icon') ?><?php endif ?><?php echo $this->getGroupMessage('form_title_closer') ?></label>
	...
	<?php else: ?>
		...
		<?php /* input */ ?><?php echo $this->getTemplate()->Form()->drawPasswordField($element.'_double', '', ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']); ?>
	...
	<?php if ($this->getEditElementOption($element.'_double', 'notice')!=''): ?>
		<div class="text-info"><?php echo \osWFrame\Core\HTML::outputString($this->getEditElementOption($element.'_double', 'notice')) ?></div>
	<?php endif ?>
