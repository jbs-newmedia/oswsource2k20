...
if (($this->getFilterErrorElementStorage($element)!==true)&&(strlen($file_name)>0)) {
	...
	if ($getimagesize!==false) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getEditElementValidation($element, 'width_min')!='')) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getEditElementValidation($element, 'width_max')!='')) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getEditElementValidation($element, 'height_min')!='')) {
		...
		if (($this->getFilterErrorElementStorage($element)!==true)&&($this->getEditElementValidation($element, 'height_max')!='')) {
