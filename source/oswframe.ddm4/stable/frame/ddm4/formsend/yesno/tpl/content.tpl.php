	...
	<?php else: ?>
			...
			<div class="form-check-inline">
				<label class="form-check-label">
					<div class="custom-control custom-radio">
						<?php echo $this->getTemplate()->Form()->drawRadioField($element, '1', $this->getSendElementStorage($element), ['input_class'=>'custom-control-input']) ?>
		...
		<?php endif ?><?php if ($key=='n'): ?>
			<div class="form-check-inline">
				<label class="form-check-label">
					<div class="custom-control custom-radio">
						<?php echo $this->getTemplate()->Form()->drawRadioField($element, '0', $this->getSendElementStorage($element), ['input_class'=>'custom-control-input']) ?>
