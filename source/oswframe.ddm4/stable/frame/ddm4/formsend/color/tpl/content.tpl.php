...
<div class="form-group ddm_element_<?php echo $this->getSendElementValue($element, 'id') ?>">
	...
	<?php if ($this->getSendElementOption($element, 'read_only')===true): ?>
		...
		<?php /* read only */ ?>
		<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString($this->getSendElementStorage($element)); ?></div>        <?php echo $this->getTemplate()->Form()->drawHiddenField($element, $this->getSendElementStorage($element)) ?>
	...
	<?php /* input */ ?>
		...
		<div class="input-group">
			<?php echo $this->getTemplate()->Form()->drawInputField($element.'_helper', $this->getSendElementStorage($element), ['input_class'=>'form-control form-control-color w-25', 'input_errorclass'=>'is-invalid'], 'color'); ?>

			<?php echo $this->getTemplate()->Form()->drawTextField($element, $this->getSendElementStorage($element), ['input_class'=>'form-control w-75', 'input_errorclass'=>'is-invalid']); ?>
		</div>
