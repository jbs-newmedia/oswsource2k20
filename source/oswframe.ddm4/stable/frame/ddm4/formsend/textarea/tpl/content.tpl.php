...
<div class="form-group ddm_element_<?php echo $this->getSendElementValue($element, 'id') ?>">
	...
	<?php else: ?>
		...
		<?php /* input */ ?><?php echo $this->getTemplate()->Form()->drawTextareaField($element, $this->getSendElementStorage($element), ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']); ?>
