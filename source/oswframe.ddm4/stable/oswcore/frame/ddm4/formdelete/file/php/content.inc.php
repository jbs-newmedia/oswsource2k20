...
if (Settings::getAction() === 'dodelete') {
    ...
    $this->setDoDeleteElementStorage(
        $element . $this->getDeleteElementOption($element, 'temp_suffix'),
        osWFrame\Core\Settings::catchValue($element . $this->getDeleteElementOption($element, 'temp_suffix'), '', 'p')
    );

    if (($this->getDeleteElementOption($element, 'store_name') === true) || ($this->getDeleteElementOption(
        $element,
        'store_type'
    ) === true) || ($this->getDeleteElementOption(
        $element,
        'store_size'
    ) === true) || ($this->getDeleteElementOption(
        $element,
        'store_md5'
    ) === true) || ($this->getDeleteElementOption($element, 'store_sha1') === true)
    ) {
    ...
    if ($this->getDeleteElementOption($element, 'store_name') === true) {
        ...
        $this->addDataElement($element . '_name', [
            'module' => 'hidden',
            'name' => $this->getDeleteElementValue($element, 'name') . '_name',
        ]);
    }
    ...
    if ($this->getDeleteElementOption($element, 'store_type') === true) {
        ...
        $this->addDataElement($element . '_type', [
            'module' => 'hidden',
            'name' => $this->getDeleteElementValue($element, 'name') . '_type',
        ]);
    }
    ...
    if ($this->getDeleteElementOption($element, 'store_size') === true) {
        ...
        $this->addDataElement($element . '_size', [
            'module' => 'hidden',
            'name' => $this->getDeleteElementValue($element, 'name') . '_size',
        ]);
    }
    ...
    if ($this->getDeleteElementOption($element, 'store_md5') === true) {
        ...
        $this->addDataElement($element . '_md5', [
            'module' => 'hidden',
            'name' => $this->getDeleteElementValue($element, 'name') . '_md5',
        ]);
    }
    ...
    if ($this->getDeleteElementOption($element, 'store_sha1') === true) {
        ...
        $this->addDataElement($element . '_sha1', [
            'module' => 'hidden',
            'name' => $this->getDeleteElementValue($element, 'name') . '_sha1',
        ]);
    }
}
