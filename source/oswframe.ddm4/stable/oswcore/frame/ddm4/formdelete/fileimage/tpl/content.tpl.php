...
<div class="form-group ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
    ...
    <div class="form-control readonly">
        <?php if ($this->getDeleteElementStorage($element) !== ''): ?>
            <a target="_blank"
               href="<?php echo $this->getDeleteElementStorage($element) ?>"><?php echo HTML::outputString(
                   $this->getDeleteElementOption($element, 'text_file_view')
               ) ?></a>
            <?php $this->getTemplate()->Form()->drawHiddenField(
                $element,
                $this->getDeleteElementStorage($element)
            ) ?><?php else: ?><?php echo HTML::outputString(
                $this->getDeleteElementOption($element, 'text_blank')
            ) ?><?php endif ?>
    </div>
