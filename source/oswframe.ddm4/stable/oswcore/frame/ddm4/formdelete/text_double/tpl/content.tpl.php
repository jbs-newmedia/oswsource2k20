...
<div class="form-group ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
    ...
    <label class="form-label"
           ...
           ) ?><?php if ($this->getDeleteElementOption(
               $element,
               'required'
           ) === true
    ...
    <?php /* read only */ ?>
    <div
        class="form-control readonly"><?php echo HTML::outputString($this->getDeleteElementStorage($element)); ?></div>
...
<div class="form-group ddm_element_<?php echo $this->getDeleteElementValue($element . '_double', 'id_double') ?>">
    ...
    <label class="form-label"
           for="<?php echo $element ?>"><?php echo HTML::outputString(
               $this->getDeleteElementValue($element, 'title_double')
           ) ?><?php if ($this->getDeleteElementOption(
               $element,
               'required'
           ) === true
    ...
    <?php echo $this->getTemplate()->Form()->drawHiddenField(
        $element . '_double',
        $this->getDeleteElementStorage($element)
    ) ?>
    ...
    <?php if ($this->getDeleteElementOption($element . '_double', 'notice') !== ''): ?>
        <div
            class="text-info"><?php echo HTML::outputString(
                $this->getDeleteElementOption($element . '_double', 'notice')
            ) ?></div>
    <?php endif ?>
