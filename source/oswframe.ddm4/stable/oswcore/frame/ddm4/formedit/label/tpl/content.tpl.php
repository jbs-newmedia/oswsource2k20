...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
    ...
    <div class="form-control readonly">
        <?php if ($this->getEditElementOption($element, 'ishtml') === true): ?><?php echo $this->getEditElementOption(
            $element,
            'label'
        ) ?><?php else: ?><?php echo HTML::outputString($this->getEditElementOption($element, 'label')) ?><?php endif ?>
    </div>
