...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getEditElementOption($element, 'read_only') === true): ?>
        ...
        <?php if ($this->getEditElementOption($element, 'blank_value') === true): ?>
            ...
            <?php $data = [
                           '' => '',
                       ] + $this->getEditElementOption($element, 'data'); ?>
        ...
        <?php if ((isset($data[$this->getEditElementStorage($element)])) && ($data[$this->getEditElementStorage(
            $element
        )] !== '')
        ): ?>
            ...
            <div
                class="form-control readonly"><?php echo HTML::outputString(
                    $data[$this->getEditElementStorage($element)]
                ) ?></div>
            ...
            <?php if ($this->getEditElementValidation($element, 'module') === 'integer'): ?>
                ...
                <?php echo $this->getTemplate()->Form()->drawSelectField(
                    ...
                    [
                        ...
                        'input_parameter' => ' data-style="custom-select" data-size="' . $this->getEditElementOption(
                            $element,
                            'data_size'
                        ) . '" data-live-search="' . $this->getEditElementOption(
                            $element,
                            'live_search'
                        ) . '" title="' . $this->getEditElementOption($element, 'data_choose') . '"',
                    ]
                ) ?>
