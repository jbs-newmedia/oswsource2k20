...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getEditElementOption($element, 'read_only') === true): ?>
        ...
        <div
            ...
            ); ?></div>        <?php echo $this->getTemplate()->Form()->drawHiddenField(
                $element,
                $this->getEditElementStorage($element)
            ) ?>
    ...
    <?php /* input */ ?>
        ...
        <div class="input-group">
            <?php echo $this->getTemplate()->Form()->drawInputField(
                $element . '_helper',
                $this->getEditElementStorage($element),
                [
                    'input_class' => 'form-control form-control-color w-25',
                    'input_errorclass' => 'is-invalid',
                ],
                'color'
            ); ?>

            <?php echo $this->getTemplate()->Form()->drawTextField($element, $this->getEditElementStorage($element), [
                'input_class' => 'form-control w-75',
                'input_errorclass' => 'is-invalid',
            ]); ?>
        </div>
