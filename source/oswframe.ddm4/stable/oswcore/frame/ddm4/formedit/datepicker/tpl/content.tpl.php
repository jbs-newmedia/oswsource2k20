...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getEditElementOption($element, 'read_only') === true): ?>
        ...
        <div class="form-control readonly">
            <?php if (($this->getEditElementStorage($element) === '') || ($this->getEditElementStorage(
                $element
            ) === '0') || ($this->getEditElementStorage(
                $element
            ) === '00000000') || ($this->getEditElementStorage($element) === '0')
            ): ?>
                ---
            <?php else: ?><?php echo $this->getTemplate()->Form()->drawHiddenField(
                $element,
                \osWFrame\Core\DateTime::strftime(
                    $this->getEditElementOption($element, 'format'),
                    mktime(
                        12,
                        0,
                        0,
                ...
                str_replace('%m.', ' %B ', $this->getEditElementOption($element, 'format')),
                mktime(
                    12,
                    0,
                    0,
    ...
    <?php else: ?>
        ...
        <?php /* input */ ?><?php if (($this->getEditElementStorage($element) === '') || ($this->getEditElementStorage(
            $element
        ) === '0') || ($this->getEditElementStorage($element) === '00000000') || ($this->getEditElementStorage(
            $element
        ) === '0')
