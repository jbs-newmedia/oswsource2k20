...
if (($this->getFilterErrorElementStorage($element) !== true) && ((string)((int)($this->getDoAddElementStorage(
    $element
...
if (($this->getFilterErrorElementStorage($element) !== true) && ($this->getAddElementValidation(
    ...
    if ($this->getDoAddElementStorage($element) === '') {
        ...
        $this->setFilterErrorElementStorage($element, true);
    } elseif (strlen((string)$this->getDoAddElementStorage($element)) < $this->getAddElementValidation(
        $element,
        'length_min'
    )
    ) {
...
if (($this->getFilterErrorElementStorage($element) !== true) && ($this->getAddElementValidation(
    ...
    if (strlen((string)$this->getDoAddElementStorage($element)) > $this->getAddElementValidation(
        $element,
        'length_max'
    )
    ) {
