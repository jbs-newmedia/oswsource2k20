...
<div class="form-group ddm_element_<?php echo $this->getSendElementValue($element, 'id') ?>">
    ...
    <div class="form-control readonly">
        <?php if ($this->getSendElementOption($element, 'ishtml') === true): ?><?php echo $this->getSendElementOption(
            $element,
            'label'
        ) ?><?php else: ?><?php echo HTML::outputString($this->getSendElementOption($element, 'label')) ?><?php endif ?>
    </div>
