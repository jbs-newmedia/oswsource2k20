...
<div class="form-group ddm_element_<?php echo $this->getSendElementValue($element, 'id') ?>">
    ...
    <label class="form-label"
           for="<?php echo $element ?>"><?php echo HTML::outputString(
               ...
               'form_title_closer'
           ) ?></label><?php if ($this->getSendElementOption($element, 'read_only') === true): ?>
            ...
            <?php else: ?>
                ...
                <?php if ($this->getSendElementOption($element, 'month_asname') === true): ?>
                    ...
                    <?php echo \osWFrame\Core\DateTime::strftime(
                        str_replace('%m.', ' %B ', $this->getSendElementOption($element, 'date_format')),
                        mktime(
                            12,
                            0,
                            0,
                        ...
                        $this->getSendElementOption($element, 'date_format'),
                        mktime(
                            12,
                            0,
                            0,
