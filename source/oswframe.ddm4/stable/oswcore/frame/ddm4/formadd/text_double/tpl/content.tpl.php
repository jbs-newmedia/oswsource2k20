...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getAddElementOption($element, 'read_only') === true): ?>
        ...
        <?php /* read only */ ?>
        <div
            class="form-control readonly"><?php echo HTML::outputString($this->getAddElementStorage($element)); ?></div>
        <?php echo $this->getTemplate()->Form()->drawHiddenField($element, $this->getAddElementStorage($element)) ?>

    <?php else: ?>

        <?php /* input */ ?><?php echo $this->getTemplate()->Form()->drawTextField(
            $element,
...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element . '_double', 'id_double') ?>">
    ...
    <label class="form-label"
           for="<?php echo $element ?>"><?php echo HTML::outputString(
               $this->getAddElementValue($element, 'title_double')
           ) ?><?php if ($this->getAddElementOption($element, 'required') === true): ?><?php echo $this->getGroupMessage(
               'form_title_required_icon'
           ) ?><?php endif ?><?php echo $this->getGroupMessage('form_title_closer') ?></label>
    ...
    <?php if ($this->getAddElementOption($element . '_double', 'notice') !== ''): ?>
        <div
            class="text-info"><?php echo HTML::outputString(
                $this->getAddElementOption($element . '_double', 'notice')
            ) ?></div>
    <?php endif ?>
