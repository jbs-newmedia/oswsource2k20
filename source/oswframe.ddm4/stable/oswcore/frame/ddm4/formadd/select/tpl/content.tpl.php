...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getAddElementOption($element, 'read_only') === true): ?>
        ...
        <?php if ($this->getAddElementOption($element, 'blank_value') === true): ?>
            ...
            <?php $data = [
                           '' => '',
                       ] + $this->getAddElementOption($element, 'data'); ?>
        ...
        <?php if ((isset($data[$this->getAddElementStorage($element)])) && ($data[$this->getAddElementStorage(
            $element
        )] !== '')
        ): ?>
            ...
            <div
                class="form-control readonly"><?php echo HTML::outputString(
                    $data[$this->getAddElementStorage($element)]
                ) ?></div>
            ...
            <?php if ($this->getAddElementValidation($element, 'module') === 'integer'): ?>
                ...
                <?php echo $this->getTemplate()->Form()->drawSelectField(
                    ...
                    [
                        ...
                        'input_parameter' => ' data-style="custom-select" data-size="' . $this->getAddElementOption(
                            $element,
                            'data_size'
                        ) . '" data-live-search="' . $this->getAddElementOption(
                            $element,
                            'live_search'
                        ) . '" title="' . $this->getAddElementOption($element, 'data_choose') . '"',
                    ]
                ) ?>
