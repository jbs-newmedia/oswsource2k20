...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
    ...
    <label class="form-label"
           for="<?php echo $element ?>"><?php echo HTML::outputString(
               ...
               'form_title_closer'
           ) ?></label><?php if ($this->getAddElementOption($element, 'read_only') === true): ?>
            ...
            <?php else: ?>
                ...
                <?php if ($this->getAddElementOption($element, 'month_asname') === true): ?>
                    ...
                    <?php echo \osWFrame\Core\DateTime::strftime(
                        str_replace('%m.', ' %B ', $this->getAddElementOption($element, 'date_format')),
                        mktime(
                            12,
                            0,
                            0,
                        ...
                        $this->getAddElementOption($element, 'date_format'),
                        mktime(
                            12,
                            0,
                            0,
