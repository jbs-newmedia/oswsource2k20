...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getAddElementOption($element, 'read_only') === true): ?>
        ...
        <div class="form-control readonly"
             style="height:auto;"><?php echo HTML::outputString($this->getAddElementStorage($element)); ?></div>
    ...
    <?php else: ?>
        ...
        <?php echo $this->getTemplate()->Form()->drawTextareaField($element, $this->getAddElementStorage($element), [
