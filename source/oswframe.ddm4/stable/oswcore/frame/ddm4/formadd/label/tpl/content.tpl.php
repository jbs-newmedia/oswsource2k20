...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
    ...
    <div class="form-control readonly">
        <?php if ($this->getAddElementOption($element, 'ishtml') === true): ?><?php echo $this->getAddElementOption(
            $element,
            'label'
        ) ?><?php else: ?><?php echo HTML::outputString($this->getAddElementOption($element, 'label')) ?><?php endif ?>
    </div>
