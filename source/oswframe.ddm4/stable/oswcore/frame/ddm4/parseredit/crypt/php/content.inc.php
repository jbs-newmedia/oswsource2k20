...
if ($this->getDoEditElementStorage($element) !== '') {
    ...
    if (($this->getFilterErrorElementStorage($element) !== true) && ($this->getEditElementValidation(
        ...
        } elseif (strlen($this->getDoEditElementStorage($element)) < $this->getEditElementValidation(
            $element,
            'length_min'
        )
        ) {
    ...
    if (($this->getFilterErrorElementStorage($element) !== true) && ($this->getEditElementValidation(
        ...
        if (strlen($this->getDoEditElementStorage($element)) > $this->getEditElementValidation(
            $element,
            'length_max'
        )
        ) {
