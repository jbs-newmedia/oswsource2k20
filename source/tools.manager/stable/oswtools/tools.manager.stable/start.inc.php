...
<?php $i=0;foreach(osW_Tool_Manager::getInstance()->checkPackageList($packages[$sl]) as $package_name => $package_data):$i++;?>
		<tr id="package_<?php echo md5($sl.'#'.$package_data['package'].'#'.$package_data['release'])?>">
			<td class="manager_link"><?php if(($package_data['options']['install']==false)&&(file_exists('../'.$package_data['package'].'.'.$package_data['release'].'/index.php'))):?><a href="../<?php echo $package_data['package'];?>.<?php echo $package_data['release'];?>/index.php?=<?php echo osW_Tool_Session::getInstance()->getId()?>"><?php echo $package_data['info']['name'];?></a><?php else:?><?php echo $package_data['info']['name'];?><?php endif?></td>
...
<?php endforeach?>
<?php elseif($sl=='custom'):?>
<?php $i=0;foreach($custom_tools as $package_name => $package_data):$i++;?>
		<tr id="package_<?php echo md5($sl.'#'.$package_name)?>">
			<td class="manager_link"><a href="../<?php echo $package_name;?>/index.php?=<?php echo osW_Tool_Session::getInstance()->getId()?>"><?php echo $package_name;?></a></td>
...
<?php endforeach?>
<?php elseif(count(osW_Tool_Manager::getInstance()->checkPackageList($packages[$sl]))>0):?>
<?php $i=0;foreach(osW_Tool_Manager::getInstance()->checkPackageList($packages[$sl]) as $package_name => $package_data):$i++;?>
		<tr id="package_<?php echo md5($sl.'#'.$package_data['package'].'#'.$package_data['release'])?>">
			<td class="manager_link"><?php if(($package_data['options']['install']==false)&&(file_exists('../'.$package_data['package'].'.'.$package_data['release'].'/index.php'))):?><a href="../<?php echo $package_data['package'];?>.<?php echo $package_data['release'];?>/index.php?=<?php echo osW_Tool_Session::getInstance()->getId()?>"><?php echo $package_data['info']['name'];?></a><?php else:?><?php echo $package_data['info']['name'];?><?php endif?></td>
			<td><?php echo $package_data['release'];?></td>
