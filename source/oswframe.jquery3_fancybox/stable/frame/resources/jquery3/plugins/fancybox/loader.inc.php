...
if (Resource::existsResource($this->getClassName(), $name)!==true) {
	$files=['js'.DIRECTORY_SEPARATOR.'jquery.fancybox.js', 'js'.DIRECTORY_SEPARATOR.'jquery.fancybox.min.js', 'css'.DIRECTORY_SEPARATOR.'jquery.fancybox.min.css', 'css'.DIRECTORY_SEPARATOR.'jquery.fancybox.min.css'];
...
if ($options['min']===true) {
	...
	$cssfiles=[$path.'js'.DIRECTORY_SEPARATOR.'jquery.fancybox.min.css'];
} else {
	$jsfiles=[$path.'js'.DIRECTORY_SEPARATOR.'jquery.fancybox.js'];
	$cssfiles=[$path.'js'.DIRECTORY_SEPARATOR.'jquery.fancybox.css'];
}
